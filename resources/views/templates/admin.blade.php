    ...
    <div class="container__dahboard flex ">
        ...
        <div class="container__main_content h-screen w-10/12">
            ...
            <div class="container__header bg-white h-16 flex flex-wrap justify-end  ">
              ...
              <div class=" px-4 py-1 border border-red-500 w-64">
                <div class="flex justify-end content-center">
                  <img src="{{ asset('images/kristijan-arsov-oaqYs49eyyU-unsplash.jpg') }}" class="h-14 w-14 rounded-full border shadow-sm object-cover " alt="" srcset="">

                </div>
                <div class="flex flex-col my-2 text-white border-2 shadow-lg border-white bg-black">
                  <a href="#" class=" hover:bg-gray-400 p-2">Account</a>
                  <a href="#" class=" hover:bg-gray-500 p-2">Settings</a>
                  <a href="#" class=" hover:bg-gray-600 p-2">Log out</a>
                </div>
              </div>
